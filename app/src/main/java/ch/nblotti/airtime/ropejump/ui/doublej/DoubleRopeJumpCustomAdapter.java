...
public class DoubleRopeJumpCustomAdapter extends RecyclerView.Adapter<DoubleRopeJumpCustomAdapter.ViewHolder> {
    ...
    DoubleRopeJumpCustomAdapter(Context context) {
