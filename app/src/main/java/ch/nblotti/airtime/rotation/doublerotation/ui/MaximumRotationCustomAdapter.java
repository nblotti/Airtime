...
public class MaximumRotationCustomAdapter extends RecyclerView.Adapter<MaximumRotationCustomAdapter.ViewHolder> {
    ...
    MaximumRotationCustomAdapter(Context context) {
